...
public class StaffRegistration extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_staff_registraion);
        ...
        txtDob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //date picker dialod
                dobPicker = new DatePickerDialog(StaffRegistration.this, new
                            ...
                            if (txtDob.getText().toString().trim().isEmpty()) {
                                ...
                                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                                   ...
                                   // uploadFile();
                                    ...
                                    Toast.makeText(StaffRegistration.this,
    ...
    private class AddStudentAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(StaffRegistration.this);
        ...
        protected String doInBackground(String... strings) {
            ...
            Toast.makeText(StaffRegistration.this, imgName,Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(String result) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if(success == 0) {
                        Toast.makeText(StaffRegistration.this, "Failed to add " +
                                        "student", Toast.LENGTH_SHORT).show();
                    }
                    else{
                        Toast.makeText(StaffRegistration.this, "Student successfully" +
