            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if(success == 0) {
                        ...
                        values.put(shutaProvider._ID,studentId);

                        Calendar currentTime = Calendar.getInstance();

                     values.put(shutaProvider.timestamp, String.valueOf(currentTime));

                        Uri uri = getContentResolver().insert(shutaProvider.CONTENT_URI,values);
